...
#ifndef SOLIS_CONTEXT_HEADER
#define SOLIS_CONTEXT_HEADER
...
class SOLISContext
{
	public:
		...
		**/
		...
		int GLAccumPixelIrradiance(std::vector<double>& visibilityCount, double irradiance);
